...
export default function AboutUs() {
    ...
    const toggleLabel = theme.color === 'white' ? 'Disable Dark Mode' : 'Enable Dark Mode';
    const [isChecked, setIsChecked] = useState(theme.color === 'white');

    useEffect(() => {
      setIsChecked(theme.color === 'white');
    }, [theme]);
